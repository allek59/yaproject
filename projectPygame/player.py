...
ANIMATION_RIGHT = [('%s/dog/r1.png' % ICON_DIR),
            ('%s/dog/r2.png' % ICON_DIR),
            ('%s/dog/r3.png' % ICON_DIR),
            ('%s/dog/r4.png' % ICON_DIR),
            ('%s/dog/r5.png' % ICON_DIR)]
ANIMATION_LEFT = [('%s/dog/l1.png' % ICON_DIR),
            ('%s/dog/l2.png' % ICON_DIR),
            ('%s/dog/l3.png' % ICON_DIR),
            ('%s/dog/l4.png' % ICON_DIR),
            ('%s/dog/l5.png' % ICON_DIR)]
ANIMATION_JUMP_LEFT = [('%s/dog/jl.png' % ICON_DIR, 0.1)]
ANIMATION_JUMP_RIGHT = [('%s/dog/jr.png' % ICON_DIR, 0.1)]
ANIMATION_JUMP = [('%s/dog/j.png' % ICON_DIR, 0.1)]
ANIMATION_STAY = [('%s/dog/0.png' % ICON_DIR, 0.1)]
